...
My goal is _not_ to make Recipe Robot generate perfect recipes 100% of the time. There will certainly be apps that Recipe Robot chokes on, and some recipe types are more complex to generate than others. I hope Recipe Robot will make the process of generating _standard_ recipes for _simple_ apps much faster and more consistent. The recipes generated by Recipe Robot should serve as a platform that you can customize before using and sharing.
