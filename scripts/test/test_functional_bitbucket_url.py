...
"""
test_functional_bitbucket_url.py
...
def test():
    ...
    assert_equals(
        "https://www.twocanoes.com/macdeploystick/updates/macdeploystick-software-updates.xml",
    ...
    expected_args = {
        ...
        "requirement": (
            ...
            "certificate leaf[subject.OU] = UXP6YEHSPW)"
        ),
    }
    verify_processor_args("CodeSignatureVerifier", recipes["download"], expected_args)

    assert_equals("com.twocanoes.MacDeployStick", recipes["pkg"]["Input"]["BUNDLE_ID"])
