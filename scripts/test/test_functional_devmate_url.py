...
"""
test_functional_devmate_url.py
...
def test():
    ...
    assert_equals(
        "https://updates.devmate.com/com.softorino.Waltr.xml",
    ...
    expected_args = {
        ...
        "requirement": (
            ...
            "certificate leaf[subject.OU] = M23NK4PKWX)"
        ),
    }
    ...
    expected_pkginfo = {
        "catalogs": ["testing"],
        "description": "Convert video and music directly into iPhone and iPad without iTunes.",
        "developer": developer,
    ...
    assert_equals(
        "Convert video and music directly into iPhone and iPad without iTunes.",
